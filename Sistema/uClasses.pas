...
begin
  ...
  if FDescricao = '' then raise Exception.Create('Campo Descrição requerido!!');
  if FImposto = 0 then raise Exception.Create('Campo Imposto requerido!!');
end;
...
begin
  FDescricao := Trim(FDescricao);
  if FDescricao = '' then raise Exception.Create('Campo Descrição requerido!!');
  if FTanque = 0 then raise Exception.Create('Campo Tanque requerido!!');
end;
...
begin
  if FData = 0 then raise Exception.Create('Campo Data requerido!!');
  if FHora = 0 then raise Exception.Create('Campo Hora requerido!!');
  if FBomba = 0 then raise Exception.Create('Campo Bomba requerido!!');
  if FLitros = 0 then raise Exception.Create('Campo Litros requerido!!');
  if FValor = 0 then raise Exception.Create('Campo Valor requerido!!');
end;
